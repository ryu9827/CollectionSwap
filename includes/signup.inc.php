    ...
    $age = mysqli_real_escape_string($conn, $_POST['age']);
			...
			//Check if email is valid
				...
				if ($resultCheck > 0) {
					...
					$sql = "INSERT INTO users ( user_email, user_uid, user_pwd, user_postcode,token,token_time,regtime,lastlogin_time,address,user_first,user_last,user_age) VALUES ('$email', '$uid', '$hashedPwd', '$postcode', '$token', '$token_exptime','$regtime','$lastlogin','$ads','$firstname','$lastname','$age');";
